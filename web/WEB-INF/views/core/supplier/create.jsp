        ...
        require(
                    ...
                    )
                {
                    ...
                    on(registry.byId("saveBtn"), 'click', function(){
                        submitForm('mainForm', '<s:url value="/supplier/saveAdd.action" />');
                    });
...
<body class="claro">
    ...
    <div class="pageBar">
        <div class="title"><s:text name="supplier.create"/></div>
    </div>
    ...
    <div data-dojo-type="dijit/TitlePane" data-dojo-props="title:'<s:text name="supplier.create.panel.profile" />', width:275" style="width:99%">
        ...
        <tbody>
            <tr>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.supplierCode" data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="20"/></td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.supplierName"  data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="100"/></td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.supplierAlias"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="50"/></td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.regNo"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="50"/></td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.otherRegNo"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="50"/></td>
            </tr>
            ...
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.profile.branch"/></td>
                <td>:</td>
                <td><s:checkbox name="supplier.branch"  data-dojo-type="dijit.form.CheckBox" theme="simple" /></td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><s:checkbox id="active" name="supplier.active"  data-dojo-type="dijit.form.CheckBox" theme="simple" /></td>
            </tr>
            ...
            <tr>
                ...
                <td>:</td>
                <td><s:file name="logo" type="file" data-dojo-props="showInput:'before'" data-dojo-type="dojox.form.Uploader" theme="simple"/></td>
            </tr>
        </tbody>
        </table>
    </div>
    ...
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="supplier.create.panel.contact" />', width:275" style="width:99%">
        ...
        <tbody>
            <tr>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.address1" data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="100"/></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;</td>
                <td></td>
                <td><s:textfield name="supplier.address2"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="100"/></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;</td>
                <td></td>
                <td><s:textfield name="supplier.address3"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="100"/></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;</td>
                <td></td>
                <td><s:textfield name="supplier.address4"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="100"/></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.contact.state"/></td>
                <td>:</td>
                <td><s:textfield name="supplier.state"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="50"/></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.contact.postalCode"/></td>
                <td>:</td>
                <td><s:textfield name="supplier.postalCode"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="15"/></td>
            </tr>
            <tr>
                <td><span class="required">*</span></td>
                ...
                <td>
					<s:select id="countrySelect" data-dojo-type="dijit.form.Select" data-dojo-props="required: true,maxHeight:-1" name="supplier.ctryCode" list="countries" 
                        listKey="ctryCode" listValue="ctryDesc" theme="simple"/>
				</td>
            </tr>
            <tr>
                <td><span class="required">*</span></td>
                ...
                <td>
					<s:select id="currencySelect"  data-dojo-type="dijit.form.Select" data-dojo-props="required: true,maxHeight:-1" name="supplier.currCode" list="currencies" 
                        listKey="currCode" listValue="currDesc" theme="simple"/>
				</td>
            </tr>
            <tr>
                <td><span class="required">*</span></td>
                ...
                <td>:</td>
                <td><s:textfield name="supplier.contactName" data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="50"/></td>
            </tr>
            <tr>
                <td><span class="required">*</span></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.contact.contactTel"/></td>
                <td>:</td>
                <td><s:textfield name="supplier.contactTel" data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="30"/></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.contact.contactMobile"/></td>
                <td>:</td>
                <td><s:textfield name="supplier.contactMobile"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="30" /></td>
            </tr>
            <tr>
                <td></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.contact.contactFax"/></td>
                <td>:</td>
                <td><s:textfield name="supplier.contactFax"  data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="30"/></td>
            </tr>
            <tr>
                <td><span class="required">*</span></td>
                <td>&nbsp;&nbsp;<s:text name="supplier.create.panel.contact.contactEmail" /></td>
                <td>:</td>
                <td><s:textfield name="supplier.contactEmail" data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="100"/></td>
            </tr>
        </tbody>
        </table>
    </div>
    ...
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="supplier.create.panel.communication" />', width:275" style="width:99%">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="20">:</td>
                <td><s:textfield name="supplier.mboxId" data-dojo-props="required: true" data-dojo-type="dijit.form.ValidationTextBox" theme="simple" maxlength="10"/></td>
            </tr>
        </tbody>
        </table>
    </div>
