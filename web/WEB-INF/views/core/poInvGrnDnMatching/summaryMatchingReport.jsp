                    ...
                    if (dom.byId("exportExcelBtn"))
                    {
                    	on(registry.byId("exportExcelBtn"),'click',
    						function()
                            {
                    		    ...
                    		    xhr.get({
                                    url: '<s:url value="/summaryReport/checkExcelData.action" />',
                                    handleAs: "json",
                                    ...
                                    load: function(data)
                                    {
                                        ...
                                        {
                                        	submitForm("searchForm", "<s:url value="/summaryReport/printExcel.action" />");
                                        }
                                    }
                                });
                            });
...
<body>
    ...
    <!-- Search Area -->
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="matching.summary.report.search.headerLabel" />', width:275">
             ...
             <tr>
				<td colspan="3">
					<table width = "100%">
						...
						<tr id="date">
							<td width="20%" id="dateText"><s:text name="matching.report.search.matchingdate" /></td>
							<td width="3px">:</td>
							<td>
