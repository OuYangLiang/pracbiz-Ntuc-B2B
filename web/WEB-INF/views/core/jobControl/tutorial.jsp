...
<title>Quartz Scheduler | Documentation | CronTrigger Tutorial</title>

<link rel="stylesheet" href="/ui/stylesheets/core.min.css?2013-07-31-11-35"/>
<link rel="stylesheet" href="/stylesheets/quartz-scheduler.css?2013-07-31-11-35"/>

</head>

<body id="crontrigger-page" class="quartz-scheduler-site crontrigger-page documentation-controller documentation-controller_crontrigger-page safari safari6 mac">


<div class="template-two-column container interior docs">
...
<div class="twelve columns has-sidebar content-column">
            

<div class="documentation-content">

<h1 id="crontrigger-tutorial">CronTrigger Tutorial</h1>

<h2 id="CronTriggersTutorial-Introduction">Introduction</h2>
...
<h2 id="CronTriggersTutorial-Format">Format</h2>
...
<h2 id="CronTriggersTutorial-Specialcharacters">Special characters</h2>

<ul>
<li><p><tt><strong>&#42;</strong></tt> (<em>"all values"</em>) - used to select all values within a field. For example, "<em>"
in the minute field means *"every minute"</em>.</p></li>
<li><p><tt><strong>?</strong></tt> (<em>"no specific value"</em>) - useful when you need to specify something in one of the
...
"10" in the day-of-month field, and "?" in the day-of-week field. See the examples below for clarification.</p></li>
<li><p><tt><strong>&#45;</strong></tt> &#45; used to specify ranges. For example, "10-12" in the hour field means <em>"the
hours 10, 11 and 12"</em>.</p></li>
<li><p><tt><strong>,</strong></tt> &#45; used to specify additional values. For example, "MON,WED,FRI" in the day-of-week
field means <em>"the days Monday, Wednesday, and Friday"</em>.</p></li>
<li><p><tt><strong>/</strong></tt> &#45; used to specify increments. For example, "0/15" in the seconds field means <em>"the
...
in the day-of-month field means <em>"fire every 3 days starting on the first day of the month"</em>.</p></li>
<li><p><tt><strong>L</strong></tt> (<em>"last"</em>) - has different meaning in each of the two fields in which it is
...
confusing/unexpected results.</em></p></li>
<li><p><tt><strong>W</strong></tt> (<em>"weekday"</em>) - used to specify the weekday (Monday-Friday) nearest the given day.
...
be specified when the day-of-month is a single day, not a range or list of days.</p></li>
</ul>
...
<h2 id="CronTriggersTutorial-Examples">Examples</h2>
