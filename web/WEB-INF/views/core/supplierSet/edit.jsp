                    ...
                    )
                {
                    ...
                    on(registry.byId("saveBtn"), 'click', 
                        function()
                        {
                            ...
                            submitForm('mainForm', '<s:url value="/supplierSet/saveEdit.action" />?param.setOid=<s:property value="param.setOid"/>');
                        }
                    );
                    ...
                    on(registry.byId("resetBtn"), 'click', 
                        function()
                        {
                            changeToURL('<s:url value="/supplierSet/initEdit.action" />?param.setOid=<s:property value="param.setOid"/>');
                        }
                    );
...
<body>
    ...
    <div class="pageBar">
        <div class="title"><s:text name="supplierSet.edit.title" /></div>
    </div>
