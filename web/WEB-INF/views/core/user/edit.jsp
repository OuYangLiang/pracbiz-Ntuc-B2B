    ...
    <script>
        require(
                    ...
                    )
                {
                    ...
                    {
                        if ('<s:property value="userProfile.active" />')
                        {
                    ...
                    on(registry.byId("saveBtn"), 'click', 
                        function()
                        {
                            ...
                            submitForm('mainForm', '<s:url value="/user/saveEdit.action" />?userProfile.userOid='+'<s:property value="userProfile.userOid" />' 
                                    + '&userProfile.isLocked=' + '<s:property value="userProfile.locked" />');
                        }
                    );
                    ...
                    on(registry.byId("resetBtn"), 'click', 
                        function()
                        {
                            changeToURL('<s:url value="/user/initEdit.action" />?userProfile.userOid='+'<s:property value="userProfile.userOid" />');
                        }
                    );
...
<body class="claro">
    ...
    <div class="pageBar">
        <div class="title"><s:text name='user.edit.pageBar' /></div>
    </div>
    <form id="mainForm" name="mainForm" method="post" >
    <input type="hidden" id="csrfToken" name="csrfToken" value="<s:property value='#session.csrfToken' />" />
    <s:token />
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="user.edit.usertypearea.title" />', width:275">
    	<table class="commtable">
            <tbody> 
                <tr height="25px">
                	<td width="2px"><span class="required">*</span></td>
                    <td width="30%"><s:text name='user.edit.usertypearea.userType' /></td>
                    <td width="2%">:</td>
                    <td>
                    	<s:if test="userProfile.locked">
	                    	<s:select id="userTypeSelect" name="userProfile.userType" list="userTypeList"
									listKey="userTypeOid" listValue="userTypeDesc" data-dojo-props="readOnly: true"
    ...
    <div class="space"></div>
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="user.edit.contactarea.title" />', width:275">
    	<table class="commtable">
            <tbody> 
                <tr height="25px" id="supplier" style="display:none">
                	<td width="2px"><span class="required">*</span></td>
                    <td width="30%"><s:text name='user.edit.contactarea.supplier' /></td>
                    <td width="2%">:</td>
                    <td><s:property value="userProfile.companyName" /></td>
                </tr>
                <tr height="25px" id="buyer" style="display:none">
                	<td width="2px"><span class="required">*</span></td>
                    <td width="30%"><s:text name='user.edit.contactarea.buyer' /></td>
                    <td width="2%">:</td>
                    <td><s:property value="userProfile.companyName" /></td>
                </tr>
                <tr height="25px">
                	<td width="2px"><span class="required">*</span></td>
                    <td width="30%"><s:text name='user.edit.contactarea.loginMode' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                    ...
                    <td width="30%"><s:text name='user.edit.contactarea.loginId' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td></td>
                    <td width="30%"><s:text name='user.edit.contactarea.salutation' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td><span class="required"></span></td>
                    <td width="30%"><s:text name='user.edit.contactarea.sex' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td><span class="required">*</span></td>
                    <td width="30%"><s:text name='user.edit.contactarea.name' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td><span class="required">*</span></td>
                    <td width="30%"><s:text name='user.edit.contactarea.email' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td></td>
                    <td width="30%"><s:text name='user.edit.contactarea.telephone' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td></td>
                    <td width="30%"><s:text name='user.edit.contactarea.fax' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td></td>
                    <td width="30%"><s:text name='user.edit.contactarea.mobile' /></td>
                    <td width="2%">:</td>
                    <td>
                ...
                <tr height="25px">
                	<td></td>
                    <td width="30%"><s:text name='user.edit.contactarea.active' /></td>
                    <td width="2%">:</td>
                    <td>
                    	<s:checkbox id="active" name="userProfile.active" data-dojo-type="dijit.form.CheckBox" theme="simple"/>
                    </td>
                </tr>
                <tr height="25px" id="blocked" style="display:none">
                	<td></td>
                    <td width="30%"><s:text name='user.edit.contactarea.block' /></td>
                    <td width="2%">:</td>
                    <td>
    ...
    <div class="space"></div>
    <div id="supplierList" style="display:none" data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="user.edit.supplierarea.title" />', width:275">
    	<table class="commtable">
            <tbody> 
                <tr height="25px">
                    <td>
    ...
    <div id="buyerList" style="display:none" data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="user.edit.buyerarea.title" />', width:275">
    	<table class="commtable">
            <tbody>
                <tr height="25px">
                    <td>
    ...
    <div class="space"></div>
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="user.edit.rolearea.title" />', width:275">
  		<table class="commtable">
       		<tr>
	        	<td width="350px">
	            <table>
				   	<tr><td style="font-weight:bold"><s:text name="user.edit.rolearea.available"/></td></tr>
	                <tr>
	                  	<td>
	            ...
	            <td width="350px">
	            <table>
				    <tr><td style="font-weight:bold"><s:text name="user.edit.rolearea.assigned"/></td></tr>
	                <tr>
	                 	<td>
    ...
    <div class="space"></div>
    <div data-dojo-type="dijit.TitlePane" id="storeList" data-dojo-props="title:'<s:text name="user.edit.store.title" />', width:275">
  		<table class="commtable">
       		<tr>
	        	<td width="350px">
	            <table>
				   	<tr><td style="font-weight:bold"><s:text name="user.edit.area.available"/></td></tr>
                    <tr><td>
	                ...
	                <tr>
						...
						<s:select id="areaAvailabel" name="availabelAreasList" list="availabelAreasList" multiple="true"
								...
								data-dojo-type="dijit.form.MultiSelect"
								cssStyle="width:300px; height:100px; font-family:Arial, Helvetica, sans-serif; " theme="simple"/>
						</td>
	                </tr>
	            </table>
	            </td>
	            ...
	            <td width="350px">
	            <table>
				    <tr><td style="font-weight:bold"><s:text name="user.edit.area.assigned"/></td></tr>
				    <tr><td>
       		...
       		<tr>
	        	<td width="350px">
	            <table>
				   	<tr><td style="font-weight:bold"><s:text name="user.edit.store.available"/></td></tr>
				   	<tr><td>
	            ...
	            <td width="350px">
	            <table>
				    <tr><td style="font-weight:bold"><s:text name="user.edit.store.assigned"/></td></tr>
				    <tr><td>
    ...
    <div class="space"></div>
    <div id="groupList" data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="user.edit.grouparea.title" />', width:275">
    	<table class="commtable">
            <tbody> 
                <tr height="25px">
                    <td>
                    	<s:if test="userProfile.locked">
                    		<s:checkbox id="addToGroup" name="addToGroup" data-dojo-props="readOnly: true"
                    			 	data-dojo-type="dijit.form.CheckBox" theme="simple"/>
                			<s:text name="user.edit.group.isAddToGroup" />
	                    	<s:select id="group" name="userProfile.groupOid" list="groupList"
									listKey="groupOid" listValue="groupName" multiple="false" data-dojo-props="readOnly: true"
									data-dojo-type="dijit.form.Select" theme="simple"/>
							<span class="required"><s:text name="user.edit.group.locked" /></span>
						</s:if>
						<s:else>
							<s:checkbox id="addToGroup" name="addToGroup"
                    			 	data-dojo-type="dijit.form.CheckBox" theme="simple"/>
                			<s:text name="user.edit.group.isAddToGroup" />
							<s:select id="group" name="userProfile.groupOid" list="groupList"
