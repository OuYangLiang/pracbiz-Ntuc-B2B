			...
			function(dom, domStyle, registry, on, Button, Select, 
				...
				on(registry.byId("selectBtn"), 'click', function() {
                    ...
                    xhr.get({
                            ...
                            load: function(data)
                            {
                            	var tc1 = opener.document.getElementById("termCondition1");
            					var tc2 = opener.document.getElementById("termCondition2");
            					var tc3 = opener.document.getElementById("termCondition3");
            					var tc4 = opener.document.getElementById("termCondition4");
