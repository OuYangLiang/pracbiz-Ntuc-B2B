                    ...
                    if (dom.byId("exportExcelBtn"))
                    {
                    	on(registry.byId("exportExcelBtn"),'click',
    						function()
                            {
                    		    ...
                    		    xhr.get({
                                    url: '<s:url value="/dnDiscrepancyReport/checkExcelData.action" />',
                                    ...
                                    load: function(data)
                                    {
                                        ...
                                        {
                                        	submitForm("searchForm", "<s:url value="/dnDiscrepancyReport/printExcel.action" />");
                                        }
                                    }
                                });
                            });
...
<body>
    ...
    <!-- Search Area -->
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="dn.discrepancy.report.search.headerLabel" />', width:275">
             ...
             <tr>
				<td colspan="3">
					<table width = "100%">
						...
						<tr id="discrepancy">
							<td width="20%"><s:text name="dn.discrepancy.report.search.dnDiscrepancy" /></td>
							<td width="3px">:</td>
							<td>
								<s:select data-dojo-type="dijit/form/FilteringSelect" name="param.discrepancyType" list="dnDiscrepancy" 
