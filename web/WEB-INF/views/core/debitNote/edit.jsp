...
<head>
    ...
    <script>
                    ...
                    )
                {
                    ...
                    on(registry.byId("saveBtn"), 'click', 
                        function()
                        {
                            ...
                            submitForm('mainForm', '<s:url value="/dn/saveEdit.action" />'+'?dnHeaderEx.dnOid=<s:property value="dnHeaderEx.dnOid"/>&dnHeaderEx.buyerOid=<s:property value="dnHeaderEx.buyerOid"/>');
                        }
                    );
                    ...
                    on(registry.byId("resetBtn"), 'click', 
                        function()
                        {
                            changeToURL('<s:url value="/dn/initEdit.action" />'+'?param.buyerOid=<s:property value="dnHeaderEx.dnOid"/>');
                        }
                    );
        ...
        var index = <s:property value="dnDetailExs.size"/>;
        function add(flag)
        {
...
<body>
    ...
    <div class="pageBar">
        <div class="title"><s:text name="dn.edit"/></div>
    </div>
    ...
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="dn.edit.header.name" />', width:275" style="width:99%">
        ...
        <tbody>
            <tr class="odd">
                 ...
                 <td class="tdData"><s:property value="dnHeaderEx.dnNo"/></td>
                 <td class="tdLabel"><s:text name="dn.edit.header.dnType"/></td>
                 <td class="tdData"><s:property value="dnHeaderEx.dnType"/>
                 <input type="hidden" value="<s:property value="dnHeaderEx.duplicate"/>" name="dnHeaderEx.duplicate"/>
                 <input type="hidden" value="<s:property value="dnHeaderEx.dnStatus"/>" name="dnHeaderEx.dnStatus"/>
                 </td>
             </tr>
             <tr class="even">
            ...
            <tr class="odd">
             ...
             <tr class="even">
                 ...
                 <td class="tdData">
                    <s:textfield id="supplierCode" readonly="true" name="dnHeaderEx.supplierCode" data-dojo-type="dijit/form/TextBox" maxlength="10" theme="simple"/>
            ...
            <tr class="odd">
             ...
             <tr class="even">
                 ...
                 <td class="tdData"><s:textfield readonly="true" name="dnHeaderEx.totalCost" id="dnHeaderEx.totalCost" data-dojo-type="dijit/form/TextBox" maxlength="10" theme="simple"/></td>
                 <td class="tdLabel"><s:text name="dn.edit.header.totalVat"/></td>
                 <td class="tdData"><s:textfield readonly="true" name="dnHeaderEx.totalVat" id="dnHeaderEx.totalVat" data-dojo-type="dijit/form/TextBox" maxlength="10" theme="simple"/></td>
             </tr>
            <tr class="odd">
                 <td class="tdLabel"><s:text name="dn.edit.header.totalCostWithVat"/></td>
                 <td class="tdData"><s:textfield readonly="true" name="dnHeaderEx.totalCostWithVat" id="dnHeaderEx.totalCostWithVat" data-dojo-type="dijit/form/TextBox" maxlength="10" theme="simple"/></td>
    ...
    <div data-dojo-type="dijit.TitlePane" data-dojo-props="title:'<s:text name="dn.edit.detail.name" />', width:275" style="width:99%">
        <table><tbody><tr><td>
            <button  type="button" data-dojo-type="dijit.form.Button" id="addBtn" onclick="add(true);"><s:text name="button.add" /></button>
        </td></tr></tbody></table>
        <div class="space"></div>
                        ...
                        <div id="itemDiv<s:property value="#status.index" />">
                            ...
                            <tbody id="tbody<s:property value="#status.index" />">
                                ...
                                <tr>
                                    ...
                                    <td><input style="width: 100%;" name="dnDetailExs[<s:property value="#status.index" />].costDiscountPercentVal" value="<s:property value="#item.costDiscountPercentVal"/>" data-dojo-type="dijit.form.NumberTextBox"  data-dojo-props="maxLength:2,constraints : {pattern: '###0'}"/></td>
