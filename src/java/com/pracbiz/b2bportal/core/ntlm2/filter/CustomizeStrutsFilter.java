 ...
 * @author jiangming
 */
public class CustomizeStrutsFilter extends StrutsPrepareAndExecuteFilter implements CoreCommonConstants
{
    ...
    public void init(FilterConfig filterConfig) throws ServletException 
    {
        ...
        {
            throw new ServletException("TestFilter filter initialization failed. Reason: " + e, e);
        }
        ...
        FilterChain chain) throws IOException, ServletException
    {
        ...
        Object currUser = ActionContext.getContext().getSession().get(SESSION_KEY_USER);
        String uri = RequestUtils.getServletPath((HttpServletRequest)request);
        if(currUser != null
            || StringUtils.startsWithIgnoreCase(uri, "/service"))
        {
