 ...
 * @author liyong
 */
public class DefaultStandardCnReportEngine extends DefaultCnReportEngine
    implements CoreCommonConstants
{
    private static final Logger log = LoggerFactory.getLogger(DefaultStandardCnReportEngine.class);
    ...
    {
        return "reports/standard/cn/STANDARD_CON_CN.jasper";
    }
