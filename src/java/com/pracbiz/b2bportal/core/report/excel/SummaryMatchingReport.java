...
public class SummaryMatchingReport
{
    @Autowired private transient BuyerStoreService buyerStoreService;
    
    public byte[] exportExcel(List<MatchingReportParameter> matchingList, BuyerHolder buyer, String title) throws Exception
    {
        ...
        try
        {
            ...
            createSummaryField(sheet, buyer, title);
    ...
    private void createSummaryField(WritableSheet ws, BuyerHolder buyer, String title) throws Exception
    {
    ...
    private void createItem(WritableSheet ws, List<MatchingReportParameter> matchingList) throws Exception
    {
        ...
        for (int i = 0; i < matchingList.size(); i++)
        {
            ...
            ws.mergeCells(0, row + 2, col + 2, row + 2);
