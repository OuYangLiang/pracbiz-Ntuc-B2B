 ...
 * @author ouyang
 */
public class PoDocMsg extends DocMsg
{
    ...
    {
        return this.getData().getPoHeader().computePdfFilename();
    }
    ...
    {
        ReportEngineParameter<PoHolder> rlt = new ReportEngineParameter<PoHolder>();
