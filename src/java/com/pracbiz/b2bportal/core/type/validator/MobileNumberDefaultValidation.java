...
public class MobileNumberDefaultValidation extends FieldValidatorSupport
{
    private static final String VLD_PTN_KEY_MOBILE_NUMBER = "MOBILE_NUMBER";
    @Autowired
    private ValidationConfigHelper validationConfig;
    private boolean trim;


    public MobileNumberDefaultValidation()
    {
        trim = true;
    }
    ...
    public void validate(Object object) throws ValidationException
    {
        ...
        Pattern pattern = Pattern.compile(validationConfig
                .getCachePattern(VLD_PTN_KEY_MOBILE_NUMBER));
