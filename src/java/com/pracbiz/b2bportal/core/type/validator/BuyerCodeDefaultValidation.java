...
public class BuyerCodeDefaultValidation extends FieldValidatorSupport
{
    private static final String VLD_PTN_KEY_BUYER_CODE = "BUYER_CODE";
    @Autowired
    private ValidationConfigHelper validationConfig;
    private boolean trim;


    public BuyerCodeDefaultValidation()
    {
        trim = true;
    }
    ...
    public void validate(Object object) throws ValidationException
    {
        ...
        Pattern pattern = Pattern.compile(validationConfig
                .getCachePattern(VLD_PTN_KEY_BUYER_CODE));
