...
public class FaxNumberDefaultValidation extends FieldValidatorSupport
{
    private static final String VLD_PTN_KEY_FAX_NUMBER = "FAX_NUMBER";
    @Autowired
    private ValidationConfigHelper validationConfig;
    private boolean trim;


    public FaxNumberDefaultValidation()
    {
        trim = true;
    }
    ...
    public void validate(Object object) throws ValidationException
    {
        ...
        Pattern pattern = Pattern.compile(validationConfig
                .getCachePattern(VLD_PTN_KEY_FAX_NUMBER));
