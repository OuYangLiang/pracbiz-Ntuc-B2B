//*****************************************************************************
//
// File Name       :  LoginIdValidation.java
...
public class LoginIdDefaultValidation extends FieldValidatorSupport
{
    private static final String VLD_PTN_KEY_LOGIN_ID = "LOGIN_ID";
    @Autowired
    private ValidationConfigHelper validationConfig;
    private boolean trim;


    public LoginIdDefaultValidation()
    {
        trim = true;
    }
    ...
    public void validate(Object obj) throws ValidationException
    {
        ...
        Pattern pattern = Pattern.compile(validationConfig
                .getCachePattern(VLD_PTN_KEY_LOGIN_ID));
