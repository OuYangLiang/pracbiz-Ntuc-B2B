...
public class PhoneNumberDefaultValidation extends FieldValidatorSupport
{
    private static final String VLD_PTN_KEY_PHONE_NUMBER = "PHONE_NUMBER";
    @Autowired
    private ValidationConfigHelper validationConfig;
    private boolean trim;


    public PhoneNumberDefaultValidation()
    {
        trim = true;
    }
    ...
    public void validate(Object object) throws ValidationException
    {
        ...
        Pattern pattern = Pattern.compile(validationConfig
                .getCachePattern(VLD_PTN_KEY_PHONE_NUMBER));
