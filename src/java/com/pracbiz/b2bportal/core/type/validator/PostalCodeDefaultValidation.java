...
public class PostalCodeDefaultValidation extends FieldValidatorSupport
{
    private static final String VLD_PTN_KEY_POSTAL_CODE = "POSTAL_CODE";
    @Autowired
    private ValidationConfigHelper validationConfig;
    private boolean trim;


    public PostalCodeDefaultValidation()
    {
        trim = true;
    }
    ...
    public void validate(Object object) throws ValidationException
    {
        ...
        Pattern pattern = Pattern.compile(validationConfig
                .getCachePattern(VLD_PTN_KEY_POSTAL_CODE));
