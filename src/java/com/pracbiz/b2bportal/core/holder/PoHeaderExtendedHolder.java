...
public class PoHeaderExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = -5329887667395246567L;
    ...
    {
        return String.valueOf(poOid + "" + fieldName);
    }
}