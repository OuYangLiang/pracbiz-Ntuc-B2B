...
public class RtvDetailExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = 5125517533115277750L;
    ...
    {
        return String.valueOf(rtvOid + "" + lineSeqNo + "" + fieldName);
    }
}