...
public class GrnDetailExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = -7730915627144771466L;
    ...
    {
        return String.valueOf(grnOid + "" + lineSeqNo + "" + fieldName);
    }
}