...
public class PoDetailExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = 7948674652103627033L;
    ...
    {
        return String.valueOf(poOid + "" + lineSeqNo + "" + fieldName);
    }
}