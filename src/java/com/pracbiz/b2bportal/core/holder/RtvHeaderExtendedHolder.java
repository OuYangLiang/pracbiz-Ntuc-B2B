...
public class RtvHeaderExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = -6720854632742436630L;
    ...
    {
        return String.valueOf(rtvOid + "" + fieldName);
    }
}