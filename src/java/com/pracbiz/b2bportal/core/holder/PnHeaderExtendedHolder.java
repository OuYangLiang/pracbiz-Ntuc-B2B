...
public class PnHeaderExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = 7605667705694021855L;
    ...
    {
        return String.valueOf(pnOid + "" + fieldName);
    }
}