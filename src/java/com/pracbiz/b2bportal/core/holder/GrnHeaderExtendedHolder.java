...
public class GrnHeaderExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = 1996494963658210920L;
    ...
    {
        return String.valueOf(grnOid + "" + fieldName);
    }
}