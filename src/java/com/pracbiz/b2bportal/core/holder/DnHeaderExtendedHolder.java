...
public class DnHeaderExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = 928056841243358083L;
    ...
    {
        return String.valueOf(dnOid+""+fieldName);
    }
}