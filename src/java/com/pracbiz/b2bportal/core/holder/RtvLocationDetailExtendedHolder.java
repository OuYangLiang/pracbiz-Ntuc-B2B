 ...
 * @author yinchi
 */
public class RtvLocationDetailExtendedHolder extends BaseHolder {
    /**
     * 
     */
    private static final long serialVersionUID = 8002636133971127030L;
    ...
    {
        return String.valueOf(rtvOid + "" + locationLineSeqNo + "" + fieldName);
    }
}