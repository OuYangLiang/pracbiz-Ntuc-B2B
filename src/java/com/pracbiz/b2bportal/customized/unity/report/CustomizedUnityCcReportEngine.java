//*****************************************************************************
//
// File Name       :  CustomizedUnityCcReportEngine.java
 ...
 * @author liyong
 */
public class CustomizedUnityCcReportEngine extends DefaultCcReportEngine implements CoreCommonConstants
{
    protected static final Logger log = LoggerFactory
        .getLogger(DefaultStandardGrnReportEngine.class);

    @Autowired TermConditionService termConditionService;
    @Override
        ...
        ReportEngineParameter<CcHolder> parameter, int flag)
    {
        ...
        {   parameter.getData().getCcHeader().setAllEmptyStringToNull();
            ...
            TermConditionHolder termCondition = termConditionService
                .selectDefaultTermConditionBySupplierOid(parameter
                    .getSupplier().getSupplierOid());
            
            if (termCondition != null)
            {
                map.putAll(termCondition.toMapValues());
            }
