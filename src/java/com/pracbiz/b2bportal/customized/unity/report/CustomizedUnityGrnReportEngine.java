//*****************************************************************************
//
// File Name       :  CustomizedUnityGrnReportEngine.java
// Date Created    :  May 31, 2013
// Last Changed By :  $Author: LiYong $
// Last Changed On :  $Date: May 31, 2013 2:52:25 PM $
// Revision        :  $Rev: 15 $
 ...
 * @author liyong
 */
public class CustomizedUnityGrnReportEngine extends DefaultGrnReportEngine implements CoreCommonConstants
{
    ...
    protected String reportTemplate(GrnHolder data, int flag)
    {
        if (flag == 1)
        {
            return "reports/customized/grn/unity/CUSTOMIZED_UNITY_GRN" + CoreCommonConstants.REPORT_TEMPLATE_FOR_STORE_EXTENSION + ".jasper";
        }
        else
        {
            return "reports/customized/grn/unity/CUSTOMIZED_UNITY_GRN.jasper";
        }
    }
