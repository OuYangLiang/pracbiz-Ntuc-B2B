//*****************************************************************************
//
// File Name       :  WatsonsPoReportEngine.java
// Date Created    :  2013-12-19
// Last Changed By :  $Author: LiYong $
// Last Changed On :  $Date: 2013-12-19 $
// Revision        :  $Rev: 15 $
...
package com.pracbiz.b2bportal.customized.watsons.report;
 ...
 * @author liyong
 */
public class CustomizedWatsonsPoReportEngine extends DefaultPoReportEngine implements CoreCommonConstants
{
    private static final Logger log = LoggerFactory.getLogger(CustomizedWatsonsPoReportEngine.class);
        ...
        ReportEngineParameter<PoHolder> parameter, int flag)
    {
        ...
        try
        {
            ...
            if(null != parameter.getSupplier().getContactName())
            {
                map.put("SUPPLIER_CONTACT_NAME", parameter.getSupplier().getContactName());
            }
            ...
            if(null != buyerStore)
            {
                ...
                if (buyerStore.getContactTel() != null)
                {
                    map.put("STORE_CONTACT_TEL", buyerStore.getContactTel());
                }
            }
            else
            {
                map.put("STORE_CODE", parameter.getData().getLocations().get(0).getLocationCode());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationName() != null)
            {
                map.put("STORE_NAME", parameter.getData().getLocations().get(0).getLocationName());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationAddr1() != null)
            {
                map.put("STORE_ADDR1", parameter.getData().getLocations().get(0).getLocationAddr1());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationAddr2() != null)
            {
                map.put("STORE_ADDR2", parameter.getData().getLocations().get(0).getLocationAddr2());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationAddr3() != null)
            {
                map.put("STORE_ADDR3", parameter.getData().getLocations().get(0).getLocationAddr3());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationCtryCode() != null)
            {
                map.put("STORE_CTRY_CODE", parameter.getData().getLocations().get(0).getLocationCtryCode());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationPostalCode() != null)
            {
                map.put("STORE_POSTAL_CODE", parameter.getData().getLocations().get(0).getLocationPostalCode());
            }
            
            if (parameter.getData().getLocations().get(0).getLocationPostalCode() != null)
            {
                map.put("STORE_CONTACT_TEL", parameter.getData().getLocations().get(0).getLocationContactTel());
            }
    ...
    protected String reportTemplate(PoHolder data, int flag)
    {
        if (flag == 1 || flag == 3)
        {
            return "reports/customized/po/watsons/CUSTOMIZED_WATSONS_PO" + CoreCommonConstants.REPORT_TEMPLATE_FOR_STORE_EXTENSION + ".jasper";
        }
        return "reports/customized/po/watsons/CUSTOMIZED_WATSONS_PO.jasper";
