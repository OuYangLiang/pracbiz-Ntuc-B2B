 ...
 * @author liyong
 */
public class CustomizedTangsInvReportEngine extends DefaultInvReportEngine
    implements CoreCommonConstants
{
    private static final Logger log = LoggerFactory.getLogger(CustomizedTangsInvReportEngine.class);
    ...
    {
        return "reports/customized/inv/tangs/CUSTOMIZED_TANGS_CON_INV.jasper";
    }
